    ...
    <div class="admin-content" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="am-g">
            <div class="am-u-sm-10">
                <form class="am-form am-form-horizontal" method="post" action="/admin/category/{{$category->id}}"
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" id="name" placeholder="分类名称" name="name" value="{{$category->name}}"
                                   required>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <textarea class="" rows="5" id="user-intro" placeholder="输入个人简介"
                                      name="description">{{$category->name}}</textarea>
